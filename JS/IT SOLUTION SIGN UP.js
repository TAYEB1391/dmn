...
let phoneNumber = document.querySelector(".phoNum");

let gender = document.querySelector("#sex");

let subBtn = document.querySelector(".subBtn");

let err_popup = document.querySelector(".errPop");

let popupMsg = document.querySelector("#message");

let popupIcon = document.querySelector(".popIcon");

let pop_closeBtn = document.querySelector(".popClose");
...
subBtn.addEventListener("click", function() {
    ...
    if (firstName.value == 0) {
        ...
        popupMsg.innerText = `first name can't be empty`;

        popupIcon.innerHTML = `<i class="far fa-times-circle"></i>`

        popupIcon.style.color = `#e2084a`;

        pop_closeBtn.style.background = `#e2084a`;

    } else
    if (lastName.value == 0) {

        popupMsg.innerText = `last name can't be empty`;
        ...
        popupMsg.innerText = `enter your e-mail`;
    ...
    } else if (mailErr.style.display != "none") {

        popupMsg.innerText = `you have entered an invalid email address`;
        ...
        popupMsg.innerText = `password must contain at least 6 characters`;
        ...
        popupMsg.innerText = `confirm password can't be empty`;
        ...
        popupMsg.innerText = `password and confirm password does not match`;
    ...
    } else if (country.value == "sC") {

        popupMsg.innerText = `please select your country`;
        ...
        popupMsg.innerText = `please enter your phone number`;
        ...
        popupMsg.innerText = `please enter a valid phone number`;
    ...
    } else if (ageError.style.display != "none") {

        popupMsg.innerText = `you are too young to register`;
    ...
    } else if (gender.value == "sS") {

        popupMsg.innerText = `please select your sex`;
        ...
        popupMsg.innerHTML = `congrates! sign up complete`;

        popupIcon.innerHTML = `<i class ="far fa-check-circle" ></i>`

        popupIcon.style.color = `#22aa42`;

        pop_closeBtn.style.background = `#22aa42`;

    }

});

// todo: FOR CLOSE POPUP ;

pop_closeBtn.addEventListener("click", function() {
